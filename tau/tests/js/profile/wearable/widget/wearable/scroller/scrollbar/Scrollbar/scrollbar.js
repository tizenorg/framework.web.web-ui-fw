module("profile/wearable/widget/wearable/scroller/Scrollbar", {
	});

	test ( "API ns.widget.wearable.scroller.scrollbar.ScrollBar" , function () {
		var widget;
		equal(typeof tau.widget.wearable.scroller.scrollbar.ScrollBar, 'function', 'Class tau.widget.wearable.scroller.scrolbar.ScrollBar exists');
		widget = new tau.widget.wearable.scroller.scrollbar.ScrollBar();
