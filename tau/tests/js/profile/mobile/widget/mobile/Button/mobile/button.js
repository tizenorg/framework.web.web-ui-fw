...
(function() {
	...
	test('Focus events', function () {
		...
		tau.engine.instanceWidget(buttonA, 'Button');
		tau.engine.instanceWidget(buttonB, 'Button');
		tau.engine.instanceWidget(buttonC, 'Button');
	...
	test('vmouse events', function () {
		...
		tau.engine.instanceWidget(buttonA, 'Button');
		tau.event.trigger(buttonA, 'vmousedown');
		...
		tau.event.trigger(buttonA, 'vmouseup');
		...
		tau.event.trigger(buttonA, 'vmouseover');
		...
		tau.event.trigger(buttonA, 'vmouseout');
