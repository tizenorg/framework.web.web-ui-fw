...
test("ej.util.selectors - check functions with 'parent'", function () {
	...
	equal(selectors.getParents(child1).length, 8, "function getParents returns right value");
	equal(selectors.getParents(elem1).length, 7, "function getParents returns right value");
	...
	equal(selectors.getParentsByTag(child1, "div").length, 5, "function getParentsByTag returns right value");
